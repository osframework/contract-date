...
public class FileInfoOutputFactoryBean extends AbstractInfoOutputFactoryBean {
	...
	private static final FileInfoOutputType DEFAULT_TYPE = FileInfoOutputType.CSV;

	private File target = null;
	private FileInfoOutputType type = null;
	...
	public void setOutputType(String outputType) {
		...
		for (FileInfoOutputType fiot : FileInfoOutputType.values()) {
	...
	private static enum FileInfoOutputType {
		CSV("CSV"), TAB("TAB","TSV");
	
		private final Set<String> extensions;
	
		private FileInfoOutputType(final String... extensions) {
